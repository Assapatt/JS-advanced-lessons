...
var a1 = 2;
var a2 = "2";
console.log(a1==a2);//true or false 原理是什么？？？？？ true 类型转换后值相等
console.log(a1===a2); //false 类型不相同

var b1 = {};
var b2 = {};
console.log(b1==b2);//true or false 原理是什么？？？？？ false
console.log(b1===b2);//true or false  false
console.log(b1===b1);//true or false  true

//进一步理解
var c1 = 23;
var c2 = new Number(23);
console.log(c1==c2);//true or false 原理是什么？？？？？ true
console.log(c1===c2);//true or false  false
